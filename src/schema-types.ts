...
interface BaseSchema<OutputType> {
  ...
  help?: string;
  onChange?: (param: {rawValues: object, value: OutputType, setValue: (p1:any, p2:any, p3:any /*TODO*/) => void}) => void;
  disabled?: boolean;
  label?: React.ReactNode;
  className?: string;
  style?: object;
  visible?: boolean | {ref: string, test: (b: any, idx?: number) => boolean};
  render?: (props: {rawValues: object, value: OutputType, onChange: (newValue: OutputType) => void, error?:any, setValue?: (data: any)/*TODO 2 params ?*/ => void, parent: any}) => JSX.Element
}
...
interface StringTypeSchema extends BaseSchema<string> {
  type: "string";
  format?: "select" | "buttons" | "markdown" | "code" | "singleLineCode" | "textarea" | "email" | "password" | "hidden";
  defaultValue?: string;
}
